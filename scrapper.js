...
async function newSeason(page) {
    ...
    res = await axios.get(`https://www1.gogoanime.ai/new-season.html?page=${page}`)
...
async function popular(page) {
    ...
    res = await axios.get(`https://www1.gogoanime.ai/popular.html?page=${page}`)
    const body = await res.data;
    const $ = cheerio.load(body)
...
async function search(query) {
    ...
    res = await axios.get(`https://www1.gogoanime.ai/search.html?keyword=${query}`)
    const body = await res.data;
    const $ = cheerio.load(body)
...
async function anime(_anime_name) {
    ...
    res = await axios.get(`https://www1.gogoanime.ai/category/${_anime_name}`)
    const body = await res.data;
    const $ = cheerio.load(body)
...
async function watchAnime(episode_id) {
    ...
    res = await axios.get(`https://www1.gogoanime.ai/${episode_id}`)
    const body = await res.data;
    $ = cheerio.load(body)
